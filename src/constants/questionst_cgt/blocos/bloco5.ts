      ...
      options: [
        {
          id: "a",
          label: "a)",
          text: "É uma garantia pessoal que só pode ser constituída voluntariamente pelo contribuinte.",
        },
        {
          id: "b",
          label: "b)",
          text: "É uma garantia real que pode ser constituída pela Repartição Fiscal ou serviço local equiparado sobre bens do devedor quando as garantias existentes sejam insuficientes.",
        },
        {
          id: "c",
          label: "c)",
          text: "É uma garantia que só pode ser constituída por decisão judicial sobre bens de terceiros.",
        },
        {
          id: "d",
          label: "d)",
          text: "É uma garantia exclusiva para dívidas aduaneiras e é constituída pelo Tribunal.",
        },
      ],
      answer: "b",
      answerLabel:
        "b) É uma garantia real que pode ser constituída pela Repartição Fiscal ou serviço local equiparado sobre bens do devedor quando as garantias existentes sejam insuficientes.",
      explanation:
